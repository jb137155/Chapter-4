...
public class Zoo
{
    public static  void main(String[] args) throws InterruptedException 
    {
        ...
        while(!text.equals("leave"))
        {
            switch(text)
            {
                ...
                break;
                case "concessions":
                    Concessions.displayConcessionsMenu();
                break;
                case "gift shop":
    ...
    {
        //Calling primate
        Chimpanzee george = new animals.Chimpanzee();
        animals.add(george);
        Parrot Terry = new animals.Parrot();
        animals.add(Terry);
        Orangutan Bob = new animals.Orangutan();
        animals.add(Bob);
        Alligator Jerry = new animals.Alligator();
        animals.add(Jerry);
        Ring_Tailed_Lemurs Logan = new animals.Ring_Tailed_Lemurs();
        animals.add(Logan);
